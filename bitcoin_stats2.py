##CS224W, Creates a .csv file containing graph data: inDeg, outDeg, first_spend_date, last_spend date
# first_receive_date, last_receive_date, sum_bitcoin_spent, sum_bitcoin_received
...
SOURCE_FILE_ADDRESS="testing.csv"
DEST_FILE_ADDRESS="testingResult.csv"
